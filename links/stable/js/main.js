...
function cloudMake(){ 		//called at end of setMap !
	 var wordArray = [
		"power", "flood", "traffic", "crane", "water", "wind", "Obama", "Romney", "Christie", "Bloomberg", "battery park", "Sandy", "hurricane", "storm", "fire", "danger", "NYPD", "dark", "evacuate", /*"rain", "lights", "Frankenstorm", "climate", "batteries", "store", "supplies", "food", "subway", "MTA", "park", "vote", "tree", "ConEd"*/];
