...
function initialize(){
 ...
 //grab the results of a query for every tweet in database 
	d3.json("https://dev.gis.lcc.mn.gov/iMaps/cantey_queryAll.php", function(phpData) {
...
function bindData (searchWord){
	...
	d3.json("https://dev.gis.lcc.mn.gov/iMaps/cantey.php?x="+searchWord, function(queryData) {
